...
121 | [y-shaped array of numbers from x\[0\] to x\[1\]-1](shape.md#y-shaped-array-of-numbers-from-x0-to-x1-1) | `y#x[0]+prd[y]?x[1]-x[0]`
249, 268 | [offset indexes](shape.md#offset-indexes) | `x+til y`
